      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col animate-slide-in-left">
            ...
            <p className="text-base font-normal leading-relaxed text-[#1c0e0d]/80 dark:text-[#f8f6f5]/80 mb-4">
            ...
            <p className="text-base font-normal leading-relaxed text-[#1c0e0d]/80 dark:text-[#f8f6f5]/80">
